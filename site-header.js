  ...
  (function () {
    ...
    if (!document.getElementById(styleId)) {
      ...
      style.textContent =
        ...
        '.sw-page-footer__top{appearance:none;border:1px solid rgba(79,88,166,.62);background:transparent;color:#4F58A6;min-height:42px;padding:0 18px;font:inherit;font-size:11px;letter-spacing:.04em;text-transform:uppercase;cursor:pointer;transition:background .2s ease,color .2s ease,border-color .2s ease}' +
  ...
  if (!isHome) (function () {
    ...
    if (!document.getElementById(styleId)) {
      ...
      style.textContent =
        ...
        '@media(max-width:640px){.sw-subscribe-cta{display:none}}' +
