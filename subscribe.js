/* Studio-notes newsletter. Handles every [data-newsletter-form] on the page,
   submits to Formspree in the background, and stays on the page. */
(function () {
    ...
    form.addEventListener('submit', function (e) {
      ...
      fetch(form.action, {
        ...
        if (res.ok) {
          ...
          if (ok) ok.textContent = 'Thank you, you are on the list. Look out for the next studio note.';
