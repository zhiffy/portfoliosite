(function () {
  ...
  const en = {
    ...
    'home.contact.subTagline': 'New work, exhibitions, and drops, a few times a year.',
  ...
  const dictionaries = {
    ...
    'zh-Hans': {
      ...
      'home.statement.copy5': '在 <a href="/works/meet-eva-here/"><em>Meet Eva Here</em></a> 中，人们明知自己说的话可能成为公共艺术的一部分，仍然选择与 AI 伴侣交谈，因为被听见的需要压过了对提取的意识。在 <a href="/works/after-ophelia/"><em>After Ophelia</em></a> 中，我呈现了一个在 Hamlet 中说话不足 60 次的角色，如何被几个世纪他人的诠释所掩埋。',
      ...
      'home.contact.subTagline': '新作品、展览与限量发行，每年数次。',
    ...
    'zh-Hant': {
      ...
      'home.statement.copy5': '在 <a href="/works/meet-eva-here/"><em>Meet Eva Here</em></a> 中，人們明知自己說的話可能成為公共藝術的一部分，仍然選擇與 AI 伴侶交談，因為被聽見的需要壓過了對提取的意識。在 <a href="/works/after-ophelia/"><em>After Ophelia</em></a> 中，我呈現了一個在 Hamlet 中說話不足 60 次的角色，如何被幾個世紀他人的詮釋所掩埋。',
      ...
      'home.contact.subTagline': '新作品、展覽與限量發行，每年數次。',
    ...
    ja: {
      ...
      'home.statement.copy5': '<a href="/works/meet-eva-here/"><em>Meet Eva Here</em></a> では、人々は自分の言葉が公共のアートになるかもしれないと知りながら、AI コンパニオンに話しかけます。それでも話すのは、聞かれたいという必要が抽出への意識を上回るからです。<a href="/works/after-ophelia/"><em>After Ophelia</em></a> では、Hamlet の中で 60 回未満しか話さない人物が、何世紀もの他者の解釈に埋もれてきたことを示しました。',
    ...
    ko: {
      ...
      'home.statement.copy5': '<a href="/works/meet-eva-here/"><em>Meet Eva Here</em></a>에서 사람들은 자신의 말이 공공 예술이 될 수 있음을 알면서도 AI 동반자에게 말을 겁니다. 그럼에도 말하는 것은 들리고 싶다는 필요가 추출에 대한 인식보다 크기 때문입니다. <a href="/works/after-ophelia/"><em>After Ophelia</em></a>에서는 Hamlet에서 60번도 채 말하지 않는 인물이 수 세기 동안 타인의 해석 아래 묻혀 온 방식을 보여주었습니다.',
    ...
    fr: {
      ...
      'home.statement.copy5': 'Dans <a href="/works/meet-eva-here/"><em>Meet Eva Here</em></a>, les gens parlent à une compagne IA en sachant que leurs mots peuvent devenir une œuvre publique. Ils le font quand même parce que le besoin d’être entendu dépasse la conscience de l’extraction. Dans <a href="/works/after-ophelia/"><em>After Ophelia</em></a>, j’ai montré comment un personnage qui parle moins de 60 fois dans Hamlet a été enseveli sous des siècles d’interprétations par d’autres.',
