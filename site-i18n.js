(function () {
  ...
  const en = {
    ...
    'home.hero.cred': 'Exhibited at <strong>Venice Biennale</strong>, ART SG, ArtScience Museum, Taipei Dangdai',
  ...
  const dictionaries = {
    ...
    'zh-Hans': {
      ...
      'home.hero.cred': '曾展出于 <strong>Venice Biennale</strong>、ART SG、ArtScience Museum、Taipei Dangdai',
    ...
    'zh-Hant': {
      ...
      'home.hero.cred': '曾展出於 <strong>Venice Biennale</strong>、ART SG、ArtScience Museum、Taipei Dangdai',
      'home.eras.kicker': '實踐',
