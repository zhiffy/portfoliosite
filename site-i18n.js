(function () {
  ...
  const en = {
    ...
    'home.about.copy2': 'She is currently developing Unsilvered, a body of work exploring the discomfort of being both watched too closely and not seen at all.',
    ...
    'home.statement.copy6': 'I am currently developing <a href="/works/unsilvered/"><em>Unsilvered</em></a>, a body of work that explores the contemporary discomfort of being both watched too closely and not seen at all. In The Mirror, a digital mirror renders the room in full, except you.',
  ...
  const dictionaries = {
    ...
    'zh-Hans': {
      ...
      'home.about.copy2': '她目前正在创作 Unsilvered，一组作品，探讨那种既被看得太仔细、又完全不被看见的不适。',
      ...
      'home.statement.copy6': '我目前正在创作 <a href="/works/unsilvered/"><em>Unsilvered</em></a>，一组作品，探讨当代那种既被看得太仔细、又完全不被看见的不适。在 The Mirror 中，一面数字镜子完整地映出整个房间，只是没有你。',
    ...
    'zh-Hant': {
      ...
      'home.about.copy2': '她目前正在創作 Unsilvered，一組作品，探討那種既被看得太仔細、又完全不被看見的不適。',
      ...
      'home.statement.copy6': '我目前正在創作 <a href="/works/unsilvered/"><em>Unsilvered</em></a>，一組作品，探討當代那種既被看得太仔細、又完全不被看見的不適。在 The Mirror 中，一面數位鏡子完整地映出整個房間，只是沒有你。',
    ...
    ja: {
      ...
      'home.about.copy2': '現在は Unsilvered を制作しています。見られすぎることと、まったく見られないことの、その両方の居心地の悪さを扱う一連の作品です。',
      ...
      'home.statement.copy6': '現在は <a href="/works/unsilvered/"><em>Unsilvered</em></a> を制作しています。見られすぎることと、まったく見られないことの、その両方の居心地の悪さを扱う一連の作品です。The Mirror では、デジタルの鏡が部屋をそのまま映します。あなただけを除いて。',
    ...
    ko: {
      ...
      'home.about.copy2': '지금은 Unsilvered를 작업하고 있습니다. 너무 자세히 보이는 것과 전혀 보이지 않는 것, 그 두 가지 불편함을 함께 다루는 일련의 작업입니다.',
      ...
      'home.statement.copy6': '지금은 <a href="/works/unsilvered/"><em>Unsilvered</em></a>를 작업하고 있습니다. 너무 자세히 보이는 것과 전혀 보이지 않는 것, 그 두 가지 불편함을 함께 다루는 일련의 작업입니다. The Mirror에서는 디지털 거울이 방을 온전히 비춥니다. 당신만 빼고.',
    ...
    th: {
      ...
      'home.about.copy2': 'ขณะนี้เธอกำลังพัฒนา Unsilvered ชุดผลงานที่สำรวจความไม่สบายใจของการถูกจับตามองมากเกินไปและการไม่ถูกมองเห็นเลยไปพร้อมกัน',
      ...
      'home.statement.copy6': 'ขณะนี้ฉันกำลังพัฒนา <a href="/works/unsilvered/"><em>Unsilvered</em></a> ชุดผลงานที่สำรวจความไม่สบายใจร่วมสมัยของการถูกจับตามองมากเกินไปและการไม่ถูกมองเห็นเลยไปพร้อมกัน ใน The Mirror กระจกดิจิทัลสะท้อนห้องทั้งห้อง ยกเว้นคุณ',
    ...
    fr: {
      ...
      'home.about.copy2': 'Elle développe actuellement Unsilvered, un ensemble d’œuvres qui explore le malaise d’être à la fois observé de trop près et pas vu du tout.',
      ...
      'home.statement.copy6': 'Je développe actuellement <a href="/works/unsilvered/"><em>Unsilvered</em></a>, un ensemble d’œuvres qui explore le malaise contemporain d’être à la fois observé de trop près et pas vu du tout. Dans The Mirror, un miroir numérique restitue la salle entière, sauf vous.',
    ...
    es: {
      ...
      'home.about.copy2': 'Actualmente desarrolla Unsilvered, un conjunto de obras que explora la incomodidad de ser observado demasiado de cerca y a la vez no ser visto en absoluto.',
      ...
      'home.statement.copy6': 'Actualmente estoy desarrollando <a href="/works/unsilvered/"><em>Unsilvered</em></a>, un conjunto de obras que explora la incomodidad contemporánea de ser observado demasiado de cerca y a la vez no ser visto en absoluto. En The Mirror, un espejo digital muestra la sala completa, excepto a ti.',
    ...
    de: {
      ...
      'home.about.copy2': 'Derzeit entwickelt sie Unsilvered, eine Werkgruppe über das Unbehagen, gleichzeitig zu genau beobachtet und überhaupt nicht gesehen zu werden.',
      ...
      'home.statement.copy6': 'Derzeit entwickle ich <a href="/works/unsilvered/"><em>Unsilvered</em></a>, eine Werkgruppe über das gegenwärtige Unbehagen, gleichzeitig zu genau beobachtet und überhaupt nicht gesehen zu werden. In The Mirror gibt ein digitaler Spiegel den Raum vollständig wieder, nur ohne Sie.',
    ...
    it: {
      ...
      'home.about.copy2': 'Attualmente sta sviluppando Unsilvered, un corpus di opere che esplora il disagio di essere osservati troppo da vicino e al tempo stesso non essere visti affatto.',
      ...
      'home.statement.copy6': 'Attualmente sto sviluppando <a href="/works/unsilvered/"><em>Unsilvered</em></a>, un corpus di opere che esplora il disagio contemporaneo di essere osservati troppo da vicino e al tempo stesso non essere visti affatto. In The Mirror, uno specchio digitale restituisce la sala per intero, tranne te.',
  ...
  const LOCALIZED_BASES = {
    ...
    '/works/available/': 1, '/works/unsilvered/': 1, '/works/conditional/': 1, '/works/after-ophelia/': 1,
  ...
  // language slug (e.g. /works/unsilvered/zh-hans/ -> /works/unsilvered/).
